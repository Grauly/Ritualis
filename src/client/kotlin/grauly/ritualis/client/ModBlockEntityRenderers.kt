...
import grauly.ritualis.client.block.FloatingBlockEntityRenderer
...
object ModBlockEntityRenderers {
    fun init() {
        ...
        BlockEntityRendererFactories.register(ModBlockEntities.FLOATING_BOOK_ENTITY, ::FloatingBlockEntityRenderer)
    }
}