...
import grauly.ritualis.client.block.FloatingBookBlockEntityRenderer
...
object ModBlockEntityRenderers {
    fun init() {
        ...
        BlockEntityRendererFactories.register(ModBlockEntities.FLOATING_BOOK_ENTITY, ::FloatingBookBlockEntityRenderer)
    }
}